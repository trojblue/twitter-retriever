...
def move_folders(txt_file: str, base_dir: str, destination_dir: str) -> None:
    """
    ...
    :param destination_dir: The directory where the folders will be moved to.
    """
...
if __name__ == '__main__':
    ...
    move_folders(txt, source_root, destination_root)
